...
public class SwaggerConfig {
    ...
    private static final String CONTACT_NAME = "Pedro Zeferino da Silva";
    private static final String CONTACT_GITHUB = "https://gtihub.com/PedroZef";
    private static final String CONTACT_EMAIL = "zefpedro@hotmail.com";
